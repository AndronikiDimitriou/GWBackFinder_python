...
GW_train.train(thetas=None, gw_total=None, prior=prior, resume_training=True, validation_fraction=0.2, 
          ...
          path_saved="/data/users/Androniki/train_200_noise.pkl",path_inference="/data/users/Androniki/", name_file="train_400_noise.pkl", model_type="nsf", hidden_features=64, num_transforms=3)
